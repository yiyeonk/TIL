...
# # print(jumin)
#
# # jumin data의 뒷 부분을 모두 *로 변환하여 출력
# # park 850101-*******
...
# if re.match("hello","hi, world"): # None은 거짓
...
#   "   끝에 $를    "   끝   "
print(re.search("^hello", "hello, world"))  # hello로 시작하는 확인
print(re.search("world$", "hello, world"))  # hello로 시작하는 확인

print(re.match("hello|world", "hello"))  # hello 또는 world 문자열이 포함되어 있는지 확인
...
ex. [abcdef] 의미 : a, b, ..., f 주에서 어떠 한 개의 문자와 매치
"""
...
# + : 1개 이상 * 0개 이상 (바로 앞에 있는 문자에 대해서만 반복 (그룹으로 반복하는 것도 있음-추후에))
